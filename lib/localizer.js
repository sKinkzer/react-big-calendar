...
var exp = {
  ...
  weekNumber: function weekNumber() {
    ...
    return (_localizer4 = localizer).weekNumber.apply(_localizer4, arguments);
  },
  inPast: function inPast() {
    var _localizer5;

    return (_localizer5 = localizer).inPast.apply(_localizer5, arguments);
  },
  isToday: function isToday() {
    var _localizer6;

    return (_localizer6 = localizer).isToday.apply(_localizer6, arguments);
  }
};
