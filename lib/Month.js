...
var _SingleEventRow = require('./SingleEventRow');

var _SingleEventRow2 = _interopRequireDefault(_SingleEventRow);
...
var MonthView = _react2.default.createClass({
  ...
  componentWillReceiveProps: function componentWillReceiveProps(_ref) {
    ...
    this.setState({
      ...
      selectedDate: !_dates3.default.eq(date, this.props.date) ? date : this.state.selectedDate
    });
  },
  ...
  render: function render() {
    ...
    var singleRow = _props.singleRow;
    ...
    var content = singleRow ? measure && this._renderMeasureRows || this.singeRowRender : measure && this._renderMeasureRows;
    ...
    return _react2.default.createElement(
      ...
      weeks.map(function (week, idx) {
        return _this2.renderWeek(week, idx, content);
      })
    );
  },
  renderWeek: function renderWeek(week, weekIdx, content) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        !this.props.singleRow && !!extra.length && this.renderShowMore(segments, extra, week, weekIdx, levels.length)
      ),
  ...
  singeRowRender: function singeRowRender(segments, week, idx) {
    ...
    return _react2.default.createElement(_SingleEventRow2.default, _extends({}, this.props, {
      eventComponent: this.props.components.event,
      onSelect: this._selectEvent,
      key: idx,
      segments: segments,
  ...
  renderShowMore: function renderShowMore(segments, extraSegments, week, weekIdx) {
    ...
    var _endOfRange4 = (0, _eventLevels2.endOfRange)(week);

    var first = _endOfRange4.first;
    var last = _endOfRange4.last;
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          className: (0, _classnames2.default)('rbc-date-cell', {
            ...
            'rbc-selected': _dates3.default.eq(day, _this6.state.selectedDate, 'day')
          })
        },
        _this6._weekNumber(day, colIdx),
        _react2.default.createElement(
          'a',
  ...
  _weekNumber: function _weekNumber(day, colIdx) {
    if (!this.props.showWeekNumbers || colIdx !== 0) {
      return;
    }
    return _react2.default.createElement(
      'span',
      { className: 'rbc-week-number' },
      _localizer2.default.weekNumber(day)
    );
  },
