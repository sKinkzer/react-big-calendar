...
var DisplayCells = function (_React$Component) {
  ...
  DisplayCells.prototype._inPast = function _inPast(date, current) {
    return _localizer2.default.inPast(date, current);
  };

  DisplayCells.prototype._isToday = function _isToday(date, current) {
    return _localizer2.default.isToday(date, current);
  };
